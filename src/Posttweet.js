            ...
            <div className="post">
                        ...
                        <div className="tweet">
                            <form onSubmit={handleSubmit}>
                                ...
                                <br />
                                <input type="submit" style={{marginTop:'1%',backgroundColor:'rgb(29, 155, 240)', color: 'white', padding: '10px', border: 'none', borderRadius:'9999px', fontWeight: 'bold', fontSize: '16px', float: 'right'}} value="Bweet" />
                                </form>
